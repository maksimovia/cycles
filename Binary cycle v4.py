...
from modules import Node, comp, turb, heat_exch_2streams,comb_stoic,mix,heat_exch
...
def Sensitivity(PS):
    ...
    def Calc(input):
        ...
        P22 = P23
        G22 = nodes.loc['21','G']
        Node('22',G=G22,P=P22,H=H22,fluid='Water')
        ...
        heat_exch_2streams('ECON','7','8','24','25',dP2=P10*(1+dP_econ)-P10,T22=nodes.loc['26','T']-dT_econ)#25
        T6 = input[4]
        P6 = P9
        G6 = nodes.loc['5','G']
